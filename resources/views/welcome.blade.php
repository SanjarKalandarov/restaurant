    ...
    <section class="mt-8 bg-white">
        <div class="mt-4 text-center">
            ...
            <div class="container w-full px-5 py-6 mx-auto">
              ...
              @foreach($specials->menus as $welcom)
                        <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                            <img class="w-full h-48" src="{{asset('images/categories/'.$welcom->image)}}"
                                 alt="Image" />
                            <div class="px-6 py-4">

                                <h4 class="mb-3 text-xl font-semibold tracking-tight text-green-600 uppercase">{{$welcom->name}}</h4>
                                <p class="leading-normal text-gray-700">{{$welcom->descripton}}
                                </p>
                            </div>
